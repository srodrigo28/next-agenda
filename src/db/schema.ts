...
import { uuid, pgEnum, boolean, pgTable, text, integer, 
    timestamp, time } from "drizzle-orm/pg-core";
...
export const doctorsTable = pgTable("doctors", {
    ...
    // Thursday, 5 - Friday, 6 - Saturday, 0 - Sunday
    availableFromWeekDay: integer("available_from_wseek_day")
        .notNull(), // 1

    availableFromToWeekDay: integer("available_from_wseek_day")
        .notNull(), // 5
...
export const patientsTable = pgTable("patients", {
    ...
    phoneNumber: text("phone_namber").unique().notNull(),
...
export const usersToClinicsTable = pgTable("users_to_clinics", {
    ...
    createdAt: timestamp("created_at").notNull().defaultNow(),
    updatedAt: timestamp("updated_at").notNull().$onUpdate(() => new Date()),
}) // many to many para User e Clicnica
